...
# 1. 모델 불러오기
model = TimeSformer(img_size=224, num_classes=728, num_frames=8, attention_type='divided_space_time',  pretrained_model='/Users/kimminchae/Desktop/CNN/TimeSformer_divST_8x32_224_K400.pyth')

# 2. txt에서 Path 읽어서
fr = open("CCD_normal.txt", 'r')
while True:
    ...
    np.savetxt("CCD_normal.csv", numpy_array, delimiter=",")
    del numpy_array

...
if __name__ == "__main__":
    ...
    pretrained_path = "/home/alsco1234/x3d-dashcam/X3D_M.pyth"
    ...
    i = 0
    dir_path = "/projects/vode/data/CCD/Crash-1500/"
    ...
    for (root, directories, files) in os.walk(dir_path):
      for file in files:
          ...
          for video_path in video_paths:
              print("[" + str(i) + " / " + "1500] , " + str(i/1500) + "\n")

              # save one video (3, 2048)
              ...
              for j in range(0, 3):
                ...
                allout.extend(out4.tolist())

              savepath = "/projects/vode/ccd_x3d_npy/crash/"
              savepath += file_path[35:41]
              savepath += '_x3d'
              np.save(savepath, allout)
